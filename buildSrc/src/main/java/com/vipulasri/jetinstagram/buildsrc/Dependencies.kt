...
object Libs {
  const val androidGradlePlugin = "com.android.tools.build:gradle:8.5.2" // Updated AGP version
  const val junit = "junit:junit:4.13"

  const val exoplayer = "com.google.android.exoplayer:exoplayer:2.15.0" // Updated ExoPlayer version
  ...
  object Kotlin {
    private const val version = "1.9.0" // Updated Kotlin version
  ...
  object Coroutines {
    private const val version = "1.6.0" // Updated version
